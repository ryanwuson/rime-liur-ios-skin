...
local symbolicKeyboardHeight = others['竖屏']['keyboard高度'] + others['竖屏']['toolbar高度'];
...
local keyboard(theme) = {
  ...
  // 行高度樣式
  // 底部行減少 7px (54→47)，分類+內容區增加 7px (194→201)
  // 頂部間距維持不變
  HStackStyle1: { size: { height: '201/256' } },
  HStackStyle2: { size: { height: '47/256' } },
