...

{
  ...
  swipe_down: {
    ...
    k: { action: { symbol: ':' }, label: { text: ':' } },
    l: { action: { symbol: '"' }, label: { text: '"' } },
    z: { action: { shortcut: '#行首' }, label: { text: 'home' }, hintLabel: { text: '句首' }, center: { x: 0.5, y: 0.8 } },
    x: { action: { shortcut: '#cut' }, label: { text: 'cut' }, hintLabel: { text: '剪下' }, center: { x: 0.5, y: 0.8 } },
    c: { action: { shortcut: '#copy' }, label: { text: 'copy' }, hintLabel: { text: '複製' }, center: { x: 0.5, y: 0.8 } },
    v: { action: { shortcut: '#paste' }, label: { text: 'paste' }, hintLabel: { text: '貼上' }, center: { x: 0.5, y: 0.8 } },
    b: { action: 'tab', label: { text: 'tab' }, hintLabel: { text: 'Tab' }, center: { x: 0.5, y: 0.8 } },
    n: { action: { shortcut: '#selectText' }, label: { text: 'select' }, hintLabel: { text: '全選' }, center: { x: 0.5, y: 0.8 } },
    m: { action: { shortcut: '#行尾' }, label: { text: 'end' }, hintLabel: { text: '句尾' }, center: { x: 0.5, y: 0.8 } },
  },
}