...
local getToolBar(theme, orientation='portrait', keyboardType='keyboard26Chinese') = {
  ...
  preeditBackgroundStyle: {
    ...
    normalColor: color[theme]['键盘背景顏色'],
  },
  preeditForegroundStyle: {
    textColor: color[theme]['候選字體未選中字體顏色'],
  ...
  // 工具栏背景樣式（支援 Layer 3 獨立背景色）
  toolbarBackgroundStyle: {
    buttonStyleType: 'geometry',
    normalColor: color[theme][
      if keyboardType == 'numeric' then '数字键盘工具列背景顏色'
      else if keyboardType == 'symbolic' then '符號键盘工具列背景顏色'
      else if keyboardType == 'emoji' then 'emoji键盘工具列背景顏色'
      else '26键键盘工具列背景顏色'
    ],
  },
  ...
  candidateStyle: {
    ...
    preferredBackgroundColor: color[theme]['選中候選背景顏色'],
    preferredIndexColor: color[theme]['候選字體選中字體顏色'],
    preferredTextColor: color[theme]['候選字體選中字體顏色'],
    preferredCommentColor: color[theme]['候選字體選中字體顏色'],
    indexColor: color[theme]['候選字體未選中字體顏色'],
    textColor: color[theme]['候選字體未選中字體顏色'],
    commentColor: color[theme]['候選字體未選中字體顏色'],
  ...
  expandButtonForegroundStyle: {
    ...
    normalColor: color[theme][toolbarButtonColorKey],
    highlightColor: color[theme][toolbarButtonColorKey],
    fontSize: fontSize[toolbarButtonSizeKey] - 4,
  },
