...
local colorsOrDefault = function(overrides, theme, direction)
  ...
  if picked != {} then picked else { 
    normalColor: if direction == 'up' then color[theme]['上滑提示文字顏色'] else color[theme]['下滑提示文字顏色'], 
    highlightColor: if direction == 'up' then color[theme]['上滑提示文字顏色'] else color[theme]['下滑提示文字顏色'] 
  };
